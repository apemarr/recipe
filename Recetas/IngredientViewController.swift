...
class IngredientViewController:UIViewController, UITableViewDelegate, UITableViewDataSource,UISearchBarDelegate{
    ...
    var filtered:[String]!
    var ingredientes=["Aceite de Oliva","Aceite de soja","Aceite de maiz","Aceitunas","Aceitunas negras","Yogur","Champiñones","Setas","Lentejas","Garbanzos","Lechuga","Alcachofa","Acelga","Brecol","Calabaza","Calabacin","Batata","Berro","Brocoli","Cebolla","Judias","Guisantes","Coliflor","Escarola","Arroz","Chocolate","Carne de ternera","Carne de cerdo","Carne de cabra","Carne de vaca","Carne de oveja","Melon","Sandia","Kiwi","Galleta","Limon","Leche","Naranja","Platano","Pan","Atun","Anchoa","Calamar","Gamba","Langostino","Pulpo","Cangrejo","Langosta","Mejillon","Mantequilla","Margarina","Camaron","Almeja","Percebe","Sepia","Ostra","Cigala","Bacalao","Bonito","Boqueron","Caballa","Dorada","Lenguado","Merluza","Lubina","Salmon","Sardina","Trucha","Queso Cheddar","Queso Parmesano","Queso azul","Sal","Fresa","Harina","Harina de maiz","Papa","Pepino","Pimiento verde","Pimiento rojo","Pimienta","Pimentón","Tomillo","Pimenta Negra","Pimienta blanca","Orégano","Romero","Salvia","Cúrcuma","Piñones","Pasas","Nata","Almendras"]
